...
plot <- ggplot() +
  ...
  labs(
    title = "Bicing Stations in Barcelona",
    caption = "Data source: Bicing and Barcelona Open Data"
  )

# Save the plot as a PNG file
ggsave("stations_neighborhoods.png", plot = plot, width = 10, height = 10, dpi = 300, bg = "white")

# Save the plot as a JPG file
ggsave("stations_neighborhoods.jpg", plot = plot, width = 10, height = 10, dpi = 300, bg = "white")
```
